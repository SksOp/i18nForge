...
interface ColabPageProps {
    params: {
        projectId: string;
    };
}

export default function ColabPage({ params }: ColabPageProps) {
    ...
    useEffect(() => {
        const verifyColabLink = async () => {
            ...
            try {
                const response = await fetch(`/api/contributor/verify?projectId=${projectId}&token=${token}`);
            ...
            <div className="flex flex-col items-center justify-center min-h-screen p-4">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 mb-6 max-w-md w-full">
                    <p className="mb-4">
                        ...
                        Please sign in to join the project.
                    </p>
                    <Link
