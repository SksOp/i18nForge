  ...
  return (
    <Card className="border border-red-600 bg-red-50 p-4 flex flex-col gap-3  mt-4">
      ...
      <div className="flex flex-col gap-2">
        <p className="text-sm text-gray-600">Once you delete a project, there is no going back. Please be certain.</p>
        <Dialog>
          ...
          <DialogContent>
            ...
            <p className="text-sm text-gray-700">
              This action <span className="font-semibold text-red-600">cannot</span> be undone. This will permanently
